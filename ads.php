<?php include "res/include/menu.php"; ?>

<main>

    <div class="pageIntro">
        <div class = "left intro">Advertise with us!</div>
        <div class = "right"></div>
    </div>

    <div class = "content">

            <h1>Welcome to the Advertisement tab!</h1>
            ...
            <h2>Explore our users' ads!</h2>

            <?php
            
            include "app/view/advertView.php";
    ...
    <?php include "res/include/footer.php";?>
</body>
</html>